...
public class BStackHeadlessTest {
    ...
    public void setUpDriver() throws Exception{
        ...
        capabilities.setCapability("name","mainPageSnapshotHeadless");
    ...
    public void testCase() throws Exception{
        ...
        takeSnapShot(driver,FILE_PATH+"bsSnapshotHeadless.png");
    ...
    public void startLocal() throws Exception{
        ...
        bsLocalArgs.put("localIdentifier", "headless");
